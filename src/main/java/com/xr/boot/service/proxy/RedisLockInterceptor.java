package com.xr.boot.service.proxy;

import java.lang.reflect.Method;
import java.util.concurrent.TimeUnit;

import com.google.common.base.Joiner;
import com.xr.boot.util.redislock.RedisLockException;
import com.xr.boot.util.redislock.RedisLockUtil;
import com.xr.boot.util.redislock.RedisLockable;
...
public class RedisLockInterceptor {
    ...
    @Pointcut("@annotation(com.xr.boot.util.redislock.RedisLockable)")
